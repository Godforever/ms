...
class model(object):
    def __init__(self, batch_size=100, hidden_size=1024, n_output=10):
    ...
    def train_model(self, EPOCH=21):
        ...
        train_step = tf.train.AdamOptimizer(1e-4).minimize(loss_re)
        ...
        with tf.Session() as sess:
            ...
            for epoch in range(EPOCH):
                ...
                if epoch % 10 == 0:
                    ...
                    saver.save(sess, "cnn_model/my-model", global_step=epoch)
